-- TABLE
CREATE TABLE Pessoa (id integer not null, cpf varchar(255), dataNascimento varchar(255), email varchar(255), idade integer not null, nome varchar(255), primary key (id));
